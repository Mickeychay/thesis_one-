...
class Config:
    ...
    _DEFAULT_PROBLEM_DB = "data/problem_codes.json" if os.path.exists("data/problem_codes.json") else "data/problem_codes.json"
    ...
    GROUND_TRUTH_PATH = os.getenv("GROUND_TRUTH_PATH", "data/expanded_ground_truth.json")
