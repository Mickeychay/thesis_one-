...
class AblationRunner:
    ...
    def __init__(self, ground_truth_path: str = "data/expanded_ground_truth.json",
    ...
    def create_h2l_retriever(self, alpha: float = None,
        ...
        """
        from h2l.core import H2LUnifiedRetriever, H2LConfigV3
...
class RQ1_L2Filtering(AblationExperiment):
    ...
    IMPORTANT — why this is not implemented with L1_WEIGHT_BETA:
        ...
        but that formula has no implementation anywhere in core.py: β is
        ...
        The real switch is use_l2 in detector.detect_problems(), which
...
class RQ6_V6ComponentAblation(AblationExperiment):
    ...
    def run(self, ablation_runner: AblationRunner) -> pd.DataFrame:
        ...
        from h2l.core import expand_query_with_problems
...
def run_full_ablation_study(output_dir: str = "ablation_results",
    ...
    run_metadata = {
        ...
        'h2l_core_sha256': file_sha256(Path(__file__).resolve().parents[1] / 'h2l' / 'core.py'),
        'split': split,
