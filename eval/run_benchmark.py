...
def load_test_cases_from_ground_truth(ground_truth_path: str = "data/expanded_ground_truth.json") -> List[Dict]:
...
def load_problem_taxonomy(path: str = "data/problem_codes.json") -> Dict:
...
class EvaluationRunner:
    ...
    def _get_retriever(self, strategy_name: str):
        ...
        if strategy_cfg.get('use_h2l_unified'):
            ...
            # Baseline from unified_baselines.py (BM25, Dense, HyDE)
            from unified_baselines import BASELINE_REGISTRY
    ...
    def detect_problems(self, case_text: str, use_l2: bool = True) -> List[Dict]:
        ...
        Args:
            ...
            use_l2: When False, return raw L1 detections without L2 semantic
                ...
                weights. See detector.detect_problems(use_l2=...).
        """
