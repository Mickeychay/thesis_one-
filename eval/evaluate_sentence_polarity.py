...
def load_polarity_cases(gt_path="data/expanded_ground_truth.json"):
...
def load_problems_from_taxonomy(taxonomy_path="data/problem_codes.json"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--taxonomy", default="data/problem_codes.json")
