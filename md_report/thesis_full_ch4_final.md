...
**ตารางที่ 4.9 ผลเปรียบเทียบ L1+L2 กับ L1-only (n=95 เคส)**
...
**ตารางที่ 4.7 ผลการทดสอบความทนทานบน Adversarial Stress-Test Slice (n=20 เคส, qwen2.5:7b)**
...
**ตารางที่ 4.7ข ผลการตรวจจับปัญหาบน Adversarial Slice (Detector metrics, 3 models × 3 repeats = 180 runs)**
...
**ตารางที่ 4.8 ผล nDCG@10 จำแนกตามระดับความซับซ้อนของเคส (qwen2.5:7b, เฉลี่ย 3 repeats)**
