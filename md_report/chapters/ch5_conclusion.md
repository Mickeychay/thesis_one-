...
* **ความแม่นยำรวม (Accuracy): `86.00%` – `91.00%`** (แตะระดับสูงสุดที่ `91.00%` เมื่อใช้สถาปัตยกรรมเสนอแนะ)
* **อัตราการจับประโยคปฏิเสธสำเร็จ (Negation Detection Rate - NDR): `61.11%` – `72.22%`** (สามารถยับยั้งรหัสปัญหาที่ผู้รับบริการไม่ได้เป็นเองได้สูงสุด 13 จาก 18 กรณีศึกษา)
* **อัตราการเกิดข้อผิดพลาดเชิงบวก (False Positive Rate - FPR): ลดลงเหลือเพียง `2.44%` (2/82 เคส)** เมื่อใช้สถาปัตยกรรมเสนอแนะ **Hybrid Adaptive Window ร่วมกับ Clause-Boundary Segmentation และ Clinical Symptom Exceptions** จาก Baseline เดิมที่ `10.39%` (ลดลงอย่างมีนัยสำคัญถึง **-76.5%**)
* **ค่าความแม่นยำ (Precision) และ F1-Score: ทะยานขึ้นเป็น `84.62%` และ `0.7097` ตามลำดับ**

ผลลัพธ์นี้ยืนยันว่าการเสริมกลไก **Clause-Boundary Segmentation** เพื่อตัดขอบเขตคำปฏิเสธไม่ให้รั่วไหลข้ามอนุประโยคในประโยคประสม ผสานกับ **พจนานุกรมข้อยกเว้นอาการทางคลินิก (Symptom Exceptions)** ช่วยยับยั้งโมเดลไม่ให้สรุปปัญหาสังคมผิดพลาดเมื่อผู้รับบริการเล่าปฏิเสธ ในขณะที่ยังคงรักษารหัสปัญหาจริงและอาการเดือดร้อนไว้ได้อย่างครบถ้วนสมบูรณ์
...
สถาปัตยกรรม **H2L-Hybrid** ที่นำเสนอในวิทยานิพนธ์นี้ ได้รับการพิสูจน์เชิงประจักษ์บนชุดทดสอบมาตรฐาน 100 กรณีศึกษา แล้วว่า สามารถยกระดับประสิทธิภาพการค้นคืนเอกสาร (MAP = 0.3638, nDCG@10 = 0.3956) เหนือกว่า Baseline กลุ่ม dense retrieval อย่างมีนัยสำคัญทางสถิติหลังปรับ Holm ($p < 0.05$) พร้อมทั้งสามารถควบคุมประโยคปฏิเสธและลดการเกิด False Positive ได้อย่างดีเยี่ยม (Accuracy = 91.00%, Precision = 84.62%, F1 = 0.7097, False Positive Rate ลดลงเหลือ 2.44%) ซึ่งถือเป็นก้าวสำคัญในการพัฒนาระบบปัญญาประดิษฐ์ที่มีความปลอดภัยสูง เที่ยงตรง และพร้อมสำหรับการประยุกต์ใช้งานจริงในงานสังคมสงเคราะห์และสุขภาวะของประเทศไทยอย่างยั่งยืน
