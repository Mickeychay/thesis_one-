...
Usage:
    # Parse documents
    python data_pipeline.py parse

    # Merge chunks
    python data_pipeline.py merge

    # Add source metadata
    python data_pipeline.py add-source

    # Auto-tag documents
    python data_pipeline.py auto-tag <input_file>
"""
...
class DocumentTagger:
    ...
    def __init__(self, problem_codes_path: str = "problem_codes.json"):
